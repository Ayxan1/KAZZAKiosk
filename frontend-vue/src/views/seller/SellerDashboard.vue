        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
          ...
          <div class="space-y-3 mb-4 max-h-[26rem] overflow-y-auto pr-1">
            <div
              ...
              :key="item.product_id"
              class="flex justify-between items-center gap-2 p-2 rounded-lg bg-gray-50"
            >
              <div class="flex-1">
                ...
                <div class="flex items-center gap-3 mt-2">
                  ...
                  <span class="text-base font-semibold w-6 text-center">{{
                    item.quantity
                  }}</span>
                  <button
                    @click="
          ...
          <div class="border-t pt-4">
            ...
            <p
              v-if="saleSuccessMessage"
              class="text-green-600 text-sm mb-3 font-medium"
            >
              {{ saleSuccessMessage }}
            </p>
            <p
            ...
            >
              {{ completingSale ? "Tamamlanır..." : "Satışı Tamamla" }}
            </button>
          </div>
        </div>
      </div>
...
async function completeSale() {
  if (!shiftStore.isOpen || completingSale.value) {
    return;
  }
  ...
  if (success) {
    saleSuccessMessage.value = "Satış uğurla tamamlandı!";
    productStore.fetchProducts(kioskId);
    setTimeout(() => {
      saleSuccessMessage.value = "";
    }, 3000);
