<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <!-- Kiosks Tab -->
      <div v-else-if="activeTab === 'kiosks'" class="bg-white rounded-xl shadow-sm p-6">
        <h2 class="text-xl font-semibold mb-4">Kiosklar</h2>
        <div class="space-y-2">
          <div v-for="kiosk in kioskStore.kiosks" :key="kiosk.kiosk_id" 
          ...
          >
            <div class="flex justify-between items-center">
              ...
              <span :class="[
                ...
                kiosk.is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
              ]">
      ...
      <div v-else-if="activeTab === 'history'" class="bg-white rounded-xl shadow-sm p-6">
        ...
        <p class="text-gray-600">Məhsul dəyişikliklərinin tarixçəsi burada görünəcək...</p>
      </div>

      <!-- Users Tab -->
      <div v-else-if="activeTab === 'users'" class="bg-white rounded-xl shadow-sm p-6">
